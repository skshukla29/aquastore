...
export function AquaKids({ usageDeltaPercent, missions }: AquaKidsProps) {
  ...
  return (
    <Card title="AquaKids" subtitle="Playful water awareness for families">
      <div className="rounded-2xl bg-gradient-to-b from-sky-100 to-emerald-100 p-4">
        <div className="relative h-24 overflow-hidden rounded-xl bg-white/60">
          <div
            className="absolute bottom-0 left-0 right-0 rounded-t-3xl bg-gradient-to-r from-sky-500 via-cyan-400 to-emerald-400 transition-all duration-500"
